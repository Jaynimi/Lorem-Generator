...
form.addEventListener("submit", function (e) {
	...
	console.log(value);
	// variable to create a random number from 1 to text array's length
	const random = Math.floor(Math.random() * text.length);

	// If user enters no value, negative value, or numer greater than 9, generate one random lorem text.
